...
\hypertarget{md__unity_2docs_2_unity_configuration_guide}{}\label{md__unity_2docs_2_unity_configuration_guide}\index{Unity Configuration Guide@{Unity Configuration Guide}}
\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md244}%
\Hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md244}%
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md245}{}\doxysection{\texorpdfstring{C Standards, Compilers and Microcontrollers}{C Standards, Compilers and Microcontrollers}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md245}
...
All of Unity\textquotesingle{}s configuration options are {\ttfamily \#defines}. Most of these are simple definitions. A couple are macros with arguments. They live inside the \doxylink{unity__internals_8h}{unity\+\_\+internals.\+h} header file. We don\textquotesingle{}t necessarily recommend opening that file unless you really need to. That file is proof that a cross-\/platform library is challenging to build. From a more positive perspective, it is also proof that a great deal of complexity can be centralized primarily to one place to provide a more consistent and simple experience elsewhere.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md246}{}\doxysubsection{\texorpdfstring{Using These Options}{Using These Options}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md246}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md250}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+LIMITS\+\_\+H}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+LIMITS\+\_\+H}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md250}
...
If you\textquotesingle{}ve disabled both of the automatic options above, you\textquotesingle{}re going to have to do the configuration yourself. Don\textquotesingle{}t worry. Even this isn\textquotesingle{}t too bad... there are just a handful of defines that you are going to specify if you don\textquotesingle{}t like the defaults.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md251}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+INT\+\_\+\+WIDTH}}{{\ttfamily UNITY\+\_\+\+INT\+\_\+\+WIDTH}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md251}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md252}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+LONG\+\_\+\+WIDTH}}{{\ttfamily UNITY\+\_\+\+LONG\+\_\+\+WIDTH}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md252}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md253}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+POINTER\+\_\+\+WIDTH}}{{\ttfamily UNITY\+\_\+\+POINTER\+\_\+\+WIDTH}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md253}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md254}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+COMPARE\+\_\+\+PTRS\+\_\+\+ON\+\_\+\+ZERO\+\_\+\+ARRAY}}{{\ttfamily UNITY\+\_\+\+COMPARE\+\_\+\+PTRS\+\_\+\+ON\+\_\+\+ZERO\+\_\+\+ARRAY}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md254}
Define this to make all array assertions compare pointers instead of contents when a length of zero is specified. When not enabled, defining a length of zero will always result in a failure and a message warning the user that they have tried to compare empty arrays.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md255}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+SUPPORT\+\_\+64}}{{\ttfamily UNITY\+\_\+\+SUPPORT\+\_\+64}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md255}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md256}{}\doxysubsection{\texorpdfstring{Floating Point Types}{Floating Point Types}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md256}
In the embedded world, it\textquotesingle{}s not uncommon for targets to have no support for floating point operations at all or to have support that is limited to only single precision. We are able to guess integer sizes on the fly because integers are always available in at least one size. Floating point, on the other hand, is sometimes not available at all. Trying to include {\ttfamily float.\+h} on these platforms would result in an error. This leaves manual configuration as the only option.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md257}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+FLOAT}}{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+FLOAT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md257}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md258}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+FLOAT}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+FLOAT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md258}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md259}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+DOUBLE}}{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+DOUBLE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md259}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md260}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+DOUBLE}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+DOUBLE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md260}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md261}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+FLOAT\+\_\+\+PRINT}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+FLOAT\+\_\+\+PRINT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md261}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md262}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+FLOAT\+\_\+\+TYPE}}{{\ttfamily UNITY\+\_\+\+FLOAT\+\_\+\+TYPE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md262}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md263}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+DOUBLE\+\_\+\+TYPE}}{{\ttfamily UNITY\+\_\+\+DOUBLE\+\_\+\+TYPE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md263}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md264}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+FLOAT\+\_\+\+PRECISION}}{{\ttfamily UNITY\+\_\+\+FLOAT\+\_\+\+PRECISION}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md264}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md265}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+DOUBLE\+\_\+\+PRECISION}}{{\ttfamily UNITY\+\_\+\+DOUBLE\+\_\+\+PRECISION}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md265}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md266}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+IS\+\_\+\+NAN} and {\ttfamily UNITY\+\_\+\+IS\+\_\+\+INF}}{{\ttfamily UNITY\+\_\+\+IS\+\_\+\+NAN} and {\ttfamily UNITY\+\_\+\+IS\+\_\+\+INF}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md266}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md267}{}\doxysubsection{\texorpdfstring{Miscellaneous}{Miscellaneous}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md267}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md268}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+STDDEF\+\_\+H}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+STDDEF\+\_\+H}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md268}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md269}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+PRINT\+\_\+\+FORMATTED}}{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+PRINT\+\_\+\+FORMATTED}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md269}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md270}{}\doxysubsection{\texorpdfstring{Toolset Customization}{Toolset Customization}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md270}
In addition to the options listed above, there are a number of other options which will come in handy to customize Unity\textquotesingle{}s behavior for your specific toolchain. It is possible that you may not need to touch any of these... but certain platforms, particularly those running in simulators, may need to jump through extra hoops to run properly. These macros will help in those situations.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md271}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+CHAR(a)}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+CHAR(a)}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md271}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md272}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FLUSH()}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FLUSH()}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md272}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md273}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+START()}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+START()}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md273}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md274}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+COMPLETE()}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+COMPLETE()}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md274}
...
{\itshape Note\+:} {\ttfamily \doxylink{unity__internals_8h_a458886b9a590fda474d4467fa40a2367}{UNITY\+\_\+\+OUTPUT\+\_\+\+FLUSH()}} can be set to the standard out flush function simply by specifying {\ttfamily UNITY\+\_\+\+USE\+\_\+\+FLUSH\+\_\+\+STDOUT}. No other defines are required.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md275}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+ECLIPSE}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+ECLIPSE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md275}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md276}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+IAR\+\_\+\+WORKBENCH}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+IAR\+\_\+\+WORKBENCH}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md276}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md277}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+QT\+\_\+\+CREATOR}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+FOR\+\_\+\+QT\+\_\+\+CREATOR}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md277}
When managing your own builds, it is often handy to have messages output in a format which is recognized by your IDE. These are some standard formats which can be supported. If you\textquotesingle{}re using Ceedling to manage your builds, it is better to stick with the standard format (leaving these all undefined) and allow Ceedling to use its own decorators.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md278}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+PTR\+\_\+\+ATTRIBUTE}}{{\ttfamily UNITY\+\_\+\+PTR\+\_\+\+ATTRIBUTE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md278}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md279}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+EOL}}{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+EOL}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md279}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md280}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+DETAILS}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+DETAILS}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md280}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md281}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+TEST\+\_\+\+CONTEXT}}{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+TEST\+\_\+\+CONTEXT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md281}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md282}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+SETJMP}}{{\ttfamily UNITY\+\_\+\+EXCLUDE\+\_\+\+SETJMP}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md282}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md283}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+TEST\+\_\+\+PROTECT}}{{\ttfamily UNITY\+\_\+\+TEST\+\_\+\+PROTECT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md283}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md284}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+TEST\+\_\+\+ABORT}}{{\ttfamily UNITY\+\_\+\+TEST\+\_\+\+ABORT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md284}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md285}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+COLOR}}{{\ttfamily UNITY\+\_\+\+OUTPUT\+\_\+\+COLOR}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md285}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md286}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+EXEC\+\_\+\+TIME}}{{\ttfamily UNITY\+\_\+\+INCLUDE\+\_\+\+EXEC\+\_\+\+TIME}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md286}
Define this to measure and report execution time for each test in the suite. When enabled, Unity will do it\textquotesingle{}s best to automatically find a way to determine the time in milliseconds. On most Windows, macos, or Linux environments, this is automatic. If not, you can give Unity more information.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md287}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+CLOCK\+\_\+\+MS}}{{\ttfamily UNITY\+\_\+\+CLOCK\+\_\+\+MS}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md287}
If you\textquotesingle{}re working on a system (embedded or otherwise) which has an accessible millisecond timer. You can define {\ttfamily UNITY\+\_\+\+CLOCK\+\_\+\+MS} to be the name of the function which returns the millisecond timer. It will then attempt to use that function for timing purposes.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md288}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXEC\+\_\+\+TIME\+\_\+\+START}}{{\ttfamily UNITY\+\_\+\+EXEC\+\_\+\+TIME\+\_\+\+START}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md288}
Define this hook to start a millisecond timer if necessary.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md289}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+EXEC\+\_\+\+TIME\+\_\+\+STOP}}{{\ttfamily UNITY\+\_\+\+EXEC\+\_\+\+TIME\+\_\+\+STOP}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md289}
Define this hook to stop a millisecond timer if necessary.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md290}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+EXEC\+\_\+\+TIME}}{{\ttfamily UNITY\+\_\+\+PRINT\+\_\+\+EXEC\+\_\+\+TIME}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md290}
Define this hook to print the current execution time. Used to report the milliseconds elapsed.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md291}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+TIME\+\_\+\+TYPE}}{{\ttfamily UNITY\+\_\+\+TIME\+\_\+\+TYPE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md291}
Finally, this can be set to the type which holds the millisecond timer.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md292}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+INT}}{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+INT}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md292}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md293}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+MEM}}{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+MEM}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md293}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md294}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+RAW}}{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+RAW}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md294}
\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md295}{}\doxysubsubsection{\texorpdfstring{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+NONE}}{{\ttfamily UNITY\+\_\+\+SHORTHAND\+\_\+\+AS\+\_\+\+NONE}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md295}
...
{\itshape Note\+:} That feature requires variadic macro support by compiler. If required feature is not detected, it will not be enabled, even though preprocessor macro is defined.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md298}{}\doxysection{\texorpdfstring{Getting Into The Guts}{Getting Into The Guts}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md298}
There will be cases where the options above aren\textquotesingle{}t quite going to get everything perfect. They are likely sufficient for any situation where you are compiling and executing your tests with a native toolchain (e.\+g. clang on Mac). These options may even get you through the majority of cases encountered in working with a target simulator run from your local command line. But especially if you must run your test suite on your target hardware, your Unity configuration will require special help. This special help will usually reside in one of two places\+: the {\ttfamily \doxylink{test__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main()}} function or the {\ttfamily RUN\+\_\+\+TEST} macro. Let\textquotesingle{}s look at how these work.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md299}{}\doxysubsection{\texorpdfstring{{\ttfamily main()}}{{\ttfamily main()}}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md299}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\textcolor{keywordtype}{int}\ \mbox{\hyperlink{test__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main}}(\textcolor{keywordtype}{void})\ \{}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{unity__internals_8h_aaad15a5d10e50a412d0a6851d0e5091a}{UNITY\_BEGIN}}();}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{example__1_2test_2test__runners_2_test_production_code2___runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_TheFirst);}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{example__1_2test_2test__runners_2_test_production_code2___runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_TheSecond);}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{example__1_2test_2test__runners_2_test_production_code2___runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_TheThird);}
...
Let\textquotesingle{}s say you need to add a call to {\ttfamily fsync} to force all of your output data to flush to a file after each test. You could easily insert this after your {\ttfamily Unity\+Conclude\+Test} call. Maybe you want to write an xml tag before and after each result set. Again, you could do this by adding lines to this macro. Updates to this macro are for the occasions when you need an action before or after every single test case throughout your entire suite of tests.\hypertarget{md__unity_2docs_2_unity_configuration_guide_autotoc_md301}{}\doxysection{\texorpdfstring{Happy Porting}{Happy Porting}}\label{md__unity_2docs_2_unity_configuration_guide_autotoc_md301}
