...
\hypertarget{md__unity_2docs_2_unity_getting_started_guide}{}\label{md__unity_2docs_2_unity_getting_started_guide}\index{Unity -\/ Getting Started@{Unity -\/ Getting Started}}
\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md302}%
\Hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md302}%
\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md303}{}\doxysection{\texorpdfstring{Welcome}{Welcome}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md303}
...
Unity was designed to be cross-\/platform. It works hard to stick with C standards while still providing support for the many embedded C compilers that bend the rules. Unity has been used with many compilers, including GCC, IAR, Clang, Green Hills, Microchip, and MS Visual Studio. It\textquotesingle{}s not much work to get it to work with a new target.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md304}{}\doxysubsection{\texorpdfstring{Overview of the Documents}{Overview of the Documents}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md304}
\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md305}{}\doxysubsubsection{\texorpdfstring{Unity Assertions reference}{Unity Assertions reference}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md305}
This document will guide you through all the assertion options provided by Unity. This is going to be your unit testing bread and butter. You\textquotesingle{}ll spend more time with assertions than any other part of Unity.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md306}{}\doxysubsubsection{\texorpdfstring{Unity Assertions Cheat Sheet}{Unity Assertions Cheat Sheet}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md306}
This document contains an abridged summary of the assertions described in the previous document. It\textquotesingle{}s perfect for printing and referencing while you familiarize yourself with Unity\textquotesingle{}s options.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md307}{}\doxysubsubsection{\texorpdfstring{Unity Configuration Guide}{Unity Configuration Guide}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md307}
This document is the one to reference when you are going to use Unity with a new target or compiler. It\textquotesingle{}ll guide you through the configuration options and will help you customize your testing experience to meet your needs.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md308}{}\doxysubsubsection{\texorpdfstring{Unity Helper Scripts}{Unity Helper Scripts}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md308}
This document describes the helper scripts that are available for simplifying your testing workflow. It describes the collection of optional Ruby scripts included in the auto directory of your Unity installation. Neither Ruby nor these scripts are necessary for using Unity. They are provided as a convenience for those who wish to use them.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md309}{}\doxysubsubsection{\texorpdfstring{Unity License}{Unity License}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md309}
What\textquotesingle{}s an open source project without a license file? This brief document describes the terms you\textquotesingle{}re agreeing to when you use this software. Basically, we want it to be useful to you in whatever context you want to use it, but please don\textquotesingle{}t blame us if you run into problems.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md310}{}\doxysubsection{\texorpdfstring{Overview of the Folders}{Overview of the Folders}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md310}
...
\end{DoxyItemize}\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md311}{}\doxysection{\texorpdfstring{How to Create A Test File}{How to Create A Test File}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md311}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{test__runner_8c_a95c834d6178047ce9e1bce7cbfea2836}{setUp}}(\textcolor{keywordtype}{void})\ \{}
\DoxyCodeLine{\ \ \ \ \textcolor{comment}{//\ set\ stuff\ up\ here}}
\DoxyCodeLine{\}}
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{keywordtype}{void}\ \mbox{\hyperlink{test__runner_8c_a9909011e5fea0c018842eec4d93d0662}{tearDown}}(\textcolor{keywordtype}{void})\ \{}
...
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{example__1_2test_2test__runners_2_test_production_code2___runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_function\_should\_doBlahAndBlah);}
\DoxyCodeLine{\ \ \ \ \mbox{\hyperlink{example__1_2test_2test__runners_2_test_production_code2___runner_8c_af3a9b37ea192d5f498c7d699d65ad530}{RUN\_TEST}}(test\_function\_should\_doAlsoDoBlah);}
...
It\textquotesingle{}s possible that you will need more customization than this, eventually. For that sort of thing, you\textquotesingle{}re going to want to look at the configuration guide. This should be enough to get you going, though.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md312}{}\doxysubsection{\texorpdfstring{Running Test Functions}{Running Test Functions}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md312}
When writing your own {\ttfamily \doxylink{test__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main()}} functions, for a test-\/runner. There are two ways to execute the test.
...
These macros perform the necessary setup before the test is called and handles clean-\/up and result tabulation afterwards.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md313}{}\doxysubsection{\texorpdfstring{Ignoring Test Functions}{Ignoring Test Functions}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md313}
...
Ignore this test and return immediately. Output a message stating why the test was ignored.\hypertarget{md__unity_2docs_2_unity_getting_started_guide_autotoc_md314}{}\doxysubsection{\texorpdfstring{Aborting Tests}{Aborting Tests}}\label{md__unity_2docs_2_unity_getting_started_guide_autotoc_md314}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{\mbox{\hyperlink{test__runner_8c_a840291bc02cba5474a4cb46a9b9566fe}{main}}()}
\DoxyCodeLine{\{}
