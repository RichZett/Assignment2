...
\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard}{}\label{md__unity_2docs_2_throw_the_switch_coding_standard}\index{ThrowTheSwitch.org Coding Standard@{ThrowTheSwitch.org Coding Standard}}
\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md33}%
\Hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md33}%
...
;)\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md34}{}\doxysection{\texorpdfstring{Why Have A Coding Standard?}{Why Have A Coding Standard?}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md34}
Being consistent makes code easier to understand. We\textquotesingle{}ve tried to keep our standard simple because we also believe that we can only expect someone to follow something that is understandable. Please do your best.\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md35}{}\doxysection{\texorpdfstring{Our Philosophy}{Our Philosophy}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md35}
...
\item Consistent
\item Memorable
\end{DoxyEnumerate}\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md37}{}\doxysubsection{\texorpdfstring{Readable}{Readable}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md37}
We want to read our code. This means we like names and flow that are more naturally read. We try to avoid double negatives. We try to avoid cryptic abbreviations (sticking to ones we feel are common).\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md38}{}\doxysubsection{\texorpdfstring{Descriptive}{Descriptive}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md38}
...
We\textquotesingle{}ve decided on our own style preferences. If you\textquotesingle{}d like to contribute to these projects (and we hope that you do), then we ask if you do your best to follow the same. It will only hurt a little. We promise.\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md42}{}\doxysubsection{\texorpdfstring{Whitespace in C/\+C++}{Whitespace in C/\+C++}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md42}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md43}{}\doxysubsection{\texorpdfstring{Case in C/\+C++}{Case in C/\+C++}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md43}
...
\end{DoxyItemize}\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md44}{}\doxysubsection{\texorpdfstring{Braces in C/\+C++}{Braces in C/\+C++}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md44}
...
\end{DoxyCode}
\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md45}{}\doxysubsection{\texorpdfstring{Comments in C/\+C++}{Comments in C/\+C++}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md45}
Do you know what we hate? Old-\/school C block comments. BUT, we\textquotesingle{}re using them anyway. As we mentioned, our goal is to support every compiler we can, especially embedded compilers. There are STILL C compilers out there that only support old-\/school block comments. So that is what we\textquotesingle{}re using. We apologize. We think they are ugly too.\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md46}{}\doxysection{\texorpdfstring{Ruby Details}{Ruby Details}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md46}
Is there really such thing as a Ruby coding standard? Ruby is such a free form language, it seems almost sacrilegious to suggest that people should comply to one method! We\textquotesingle{}ll keep it really brief!\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md47}{}\doxysubsection{\texorpdfstring{Whitespace in Ruby}{Whitespace in Ruby}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md47}
Our Ruby style is to use spaces and to use 2 of them per indent level. It\textquotesingle{}s a nice power-\/of-\/2 number that really grooves with Ruby\textquotesingle{}s compact style. We have no more reason than that. We break that rule when we have lines that wrap. When that happens, we like to indent further to line things up in nice tidy columns.\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md48}{}\doxysubsection{\texorpdfstring{Case in Ruby}{Case in Ruby}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md48}
...
\end{DoxyItemize}\hypertarget{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md49}{}\doxysection{\texorpdfstring{Documentation}{Documentation}}\label{md__unity_2docs_2_throw_the_switch_coding_standard_autotoc_md49}
